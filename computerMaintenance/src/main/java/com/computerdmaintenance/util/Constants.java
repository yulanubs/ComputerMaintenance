...
public class Constants {
    ...
    public class Api {
         ...
         * 1、登录接口定义
         */
        public static final String LOGIN = "/ComputerDoctor/User/Login.do";
        /**
         * 2、首页功能分类接口定义
         */
        public static final String INDEX_FUNCATIONS = "/ComputerDoctor/funcations/funcationslist.do";
        /**
         * 广告位接口定义
         */
        public static final String INDEX_AB = "/ComputerDoctor/ad/adlist.do";
