...
public class ProgressBarCircularIndeterminate extends CustomView {
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        setMinimumHeight(UtilTools.dip2Px(getContext(), 32));
        setMinimumWidth(UtilTools.dip2Px(getContext(), 32));
        ...
        setMinimumHeight(UtilTools.dip2Px(getContext(), 3));
        ...
        if (radius1 < getWidth() / 2) {
            ...
            if (cont >= 50) {
                ...
                radius2 = (radius2 >= getWidth() / 2
                        - UtilTools.dip2Px(getContext(), 4)) ? (float) getWidth()
                        / 2 - UtilTools.dip2Px(getContext(), 4) : radius2 + 1;
            }
            temp.drawCircle(getWidth() / 2, getHeight() / 2, radius2,
                    transparentPaint);
            canvas.drawBitmap(bitmap, 0, 0, new Paint());
            if (radius2 >= getWidth() / 2 - UtilTools.dip2Px(getContext(), 4))
                cont++;
    ...
    private void drawSecondAnimation(Canvas canvas) {
        ...
        temp.drawCircle(getWidth() / 2, getHeight() / 2, (getWidth() / 2)
                - UtilTools.dip2Px(getContext(), 4), transparentPaint);
